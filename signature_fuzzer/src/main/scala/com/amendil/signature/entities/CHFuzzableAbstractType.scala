...
enum CHFuzzableAbstractType(_fuzzingValues: Seq[String], _chFuzzableTypes: Seq[CHFuzzableType]):
  ...
  val fuzzingValues: Seq[String] =
    if chFuzzableTypes.nonEmpty then
      _fuzzingValues.filter { fuzzingValue =>
        (Settings.Fuzzer.supportJson || !fuzzingValue.toLowerCase().contains("json")) &&
        (Settings.Fuzzer.supportLowCardinality || !fuzzingValue.toLowerCase().contains("lowcardinality")) &&
        (Settings.Fuzzer.supportNullable || !fuzzingValue.toLowerCase().contains("nullable"))
      }
    else Nil

  val exhaustiveFuzzingValues: Seq[String] =
    if chFuzzableTypes.nonEmpty then (fuzzingValues ++ chFuzzableTypes.map(_.fuzzingValues.head)).distinct
    else Nil
  ...
  case Bitmap
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.BitmapInt8).map(_.fuzzingValues.head),
        Seq(
          CHFuzzableType.BitmapBoolean,
  ...
  case IntervalDate
      extends CHFuzzableAbstractType(
        ...
        Seq(
          ...
          CHFuzzableType.LowCardinalityIntervalDay,
          CHFuzzableType.LowCardinalityIntervalWeek,
          CHFuzzableType.LowCardinalityIntervalMonth,
          CHFuzzableType.LowCardinalityIntervalQuarter,
          CHFuzzableType.LowCardinalityIntervalYear,
          CHFuzzableType.LowCardinalityNullableIntervalDay,
          CHFuzzableType.LowCardinalityNullableIntervalWeek,
          CHFuzzableType.LowCardinalityNullableIntervalMonth,
          CHFuzzableType.LowCardinalityNullableIntervalQuarter,
          CHFuzzableType.LowCardinalityNullableIntervalYear,
  ...
  case IntervalDateTime64
      extends CHFuzzableAbstractType(
        ...
        Seq(
          ...
          CHFuzzableType.LowCardinalityIntervalNanosecond,
          CHFuzzableType.LowCardinalityIntervalMicrosecond,
          CHFuzzableType.LowCardinalityIntervalMillisecond,
          CHFuzzableType.LowCardinalityNullableIntervalNanosecond,
          CHFuzzableType.LowCardinalityNullableIntervalMicrosecond,
          CHFuzzableType.LowCardinalityNullableIntervalMillisecond,
  ...
  case IntervalDateTime
      extends CHFuzzableAbstractType(
        ...
        Seq(
          ...
          CHFuzzableType.LowCardinalityIntervalSecond,
          CHFuzzableType.LowCardinalityIntervalMinute,
          CHFuzzableType.LowCardinalityIntervalHour,
          CHFuzzableType.LowCardinalityNullableIntervalSecond,
          CHFuzzableType.LowCardinalityNullableIntervalMinute,
          CHFuzzableType.LowCardinalityNullableIntervalHour,
  ...
  case UUID
      extends CHFuzzableAbstractType(
        ...
        Seq(
          CHFuzzableType.UUID,
          CHFuzzableType.LowCardinalityUUID,
          CHFuzzableType.LowCardinalityNullableUUID,
          CHFuzzableType.NullableUUID
        )
      )
  ...
  case ArrayEnum
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.ArrayEnum8.fuzzingValues.head, CHFuzzableType.ArrayEnum16.fuzzingValues.head),
        Seq(CHFuzzableType.ArrayEnum8, CHFuzzableType.ArrayEnum16)
      )
  case ArrayIPv4
  ...
  case MapDateInt
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.MapDateInt, CHFuzzableType.MapDate32Int).map(_.fuzzingValues.head),
        Seq(CHFuzzableType.MapDateInt, CHFuzzableType.MapDate32Int)
      )
  case MapDateTimeInt
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.MapDateTimeInt).map(_.fuzzingValues.head),
        Seq(CHFuzzableType.MapDateTimeInt)
      )
  case MapIntervalDateInt
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.MapIntervalDayInt).map(_.fuzzingValues.head),
        Seq(
  ...
  case MapIntervalDateTimeInt
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.MapIntervalNanosecondInt).map(_.fuzzingValues.head),
        Seq(
  ...
  case MapEnumInt
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.MapEnum8Int, CHFuzzableType.MapEnum16Int).flatMap(_.fuzzingValues),
        Seq(CHFuzzableType.MapEnum8Int, CHFuzzableType.MapEnum16Int)
      )
  case MapIPv4Int
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.MapIPv4Int).map(_.fuzzingValues.head),
        Seq(CHFuzzableType.MapIPv4Int)
      )
  case MapIPv6Int
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.MapIPv6Int).map(_.fuzzingValues.head),
        Seq(CHFuzzableType.MapIPv6Int)
      )
  case MapStringInt
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.MapFixedStringInt, CHFuzzableType.MapStringInt).map(_.fuzzingValues.head),
        Seq(CHFuzzableType.MapFixedStringInt, CHFuzzableType.MapStringInt)
      )
  case MapUUIDInt
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.MapUUIDInt).map(_.fuzzingValues.head),
  ...
  case Tuple1Date
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.Tuple1Date, CHFuzzableType.Tuple1Date32).flatMap(_.fuzzingValues),
        Seq(CHFuzzableType.Tuple1Date, CHFuzzableType.Tuple1Date32)
      )
  case Tuple1DateTime
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.Tuple1DateTime, CHFuzzableType.Tuple1DateTime64).flatMap(_.fuzzingValues),
  ...
  case Tuple1Enum
      extends CHFuzzableAbstractType(
        ...
        Seq(CHFuzzableType.Tuple1Enum8, CHFuzzableType.Tuple1Enum16)
      )
  case Tuple1IPv4
      extends CHFuzzableAbstractType(
  ...
  case ArrayArrayUUID
      extends CHFuzzableAbstractType(
        Seq(CHFuzzableType.ArrayArrayUUID.fuzzingValues.head),
        Seq(CHFuzzableType.ArrayArrayUUID)
      )
  case ArrayMapUUIDInt
      extends CHFuzzableAbstractType(
        Seq(s"[${MapUUIDInt.fuzzingValues.head}]::Array(Map(UUID, Int8))"),
        Seq(CHFuzzableType.ArrayMapUUIDInt)
      )
  case ArrayTuple1UUID
      extends CHFuzzableAbstractType(
        Seq(s"[${Tuple1UUID.fuzzingValues.head}]::Array(Tuple(UUID))"),
        Seq(CHFuzzableType.ArrayTuple1UUID)
      )
  case Tuple1ArrayUUID
      extends CHFuzzableAbstractType(
        Seq(
          s"tuple(${CHFuzzableType.ArrayUUID.fuzzingValues.head})::Tuple(Array(UUID))",
          s"tuple(${CHFuzzableType.ArrayUUID.fuzzingValues.head})::Tuple(a Array(UUID))"
        ),
        Seq(CHFuzzableType.Tuple1ArrayUUID)
      )
  case Tuple1MapUUIDInt
      extends CHFuzzableAbstractType(
        Seq(
          s"tuple(${MapUUIDInt.fuzzingValues.head})::Tuple(Map(UUID, Int8))",
          s"tuple(${MapUUIDInt.fuzzingValues.head})::Tuple(a Map(UUID, Int8))"
        ),
        Seq(CHFuzzableType.Tuple1MapUUIDInt)
      )
...
object CHFuzzableAbstractType:
  val nonCustomFuzzableAbstractTypes: Seq[CHFuzzableAbstractType] =
    CHFuzzableAbstractType.values.toSeq
      ...
      .filterNot(_.fuzzingValues.isEmpty)

  val nonCustomFuzzableTypes: Seq[CHFuzzableType] =
    nonCustomFuzzableAbstractTypes.flatMap(_.chFuzzableTypes)
